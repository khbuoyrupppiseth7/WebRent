							...
							<div class="modal-body">
								 <form role="form" method="post" enctype="multipart/form-data">
										<div class="form-group">
											...
											<select onchange="GetComId()" class="form-control" id="cboComID" name="cboCompanyID">   
												...
												<script>
													function GetComId() {
														var x = document.getElementById("cboComID").value;
														document.getElementById("txtComId").value = x;
														return x;
															}
												</script>	
												<input type="text" id="txtComId"  class="form-control" name="txtComName" >
