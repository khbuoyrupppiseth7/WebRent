...
-- ----------------------------
INSERT INTO `customer_rent_pay` VALUES ('1430192128', '1', '1430191352', '2015-05-28', '2015-05-05', '100', '0', '0', '0', '0', '100');
INSERT INTO `customer_rent_pay` VALUES ('1430292357', '1', '1430191414', '2015-05-10', '2015-05-05', '400', '0', '0', '0', '0', '400');
INSERT INTO `customer_rent_pay` VALUES ('1430295244', '1', '1430191429', '2015-06-10', '2015-05-05', '75', '0', '0', '0', '80', '155');
...
-- ----------------------------
INSERT INTO `tbcustomer` VALUES ('1428131505', '1427339560', '', 'ra', 'vy', 'ravy', '', '', '', '', 'M', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '0');
INSERT INTO `tbcustomer` VALUES ('1428133218', '1427342479', '', 'ro', 'tha', 'rotha', '', '', '', '', 'M', '1993-10-27', '', '', '', '', '', '', '', '', '', '', '', '0');
INSERT INTO `tbcustomer` VALUES ('1430295066', '1427339560', '', 'to', 'la', 'tola', '', '', '', '', 'M', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '0');
INSERT INTO `tbcustomer` VALUES ('1430295156', '1427339560', '', 'mouy', 'lay', 'mouylay', '', '', '', '', 'M', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '0');
INSERT INTO `tbcustomer` VALUES ('1430964092', '1427342479', '', 'Rith', '', 'Rith', '', '', '', 'Khmer', 'M', '1993-10-27', '', '8552', '', '', '', 'PP', '', '012444448', '', '0123333333', 'fdfasfsd@dfasdfasdfds.fsdfdsfds', '0');
INSERT INTO `tbcustomer` VALUES ('1430965079', '1427342479', '', 'Kanha', '', 'Kanha', '', '', '', '', 'F', '1993-09-15', '', 'Phnom Penh SC', '8552', '', '', '', '', '012333344', '', '092477711', 'dfsdfsdf@sdfasdfasd.cds', '0');
INSERT INTO `tbcustomer` VALUES ('1430983625', '1427339560', '', 'bun', 'long', 'bunlong', '', '', '', '', 'M', '1992-05-21', '', '', '', '', '', '', '', '', '', '', '', '0');
...
INSERT INTO `tblcustomer_rent` VALUES ('1430292357', '1428133218', '1430191414', '1427342479', '2015-05-11', '2015-05-10', '400', '', '0000-00-00', '');
...
INSERT INTO `tblcustomer_rent` VALUES ('1430730900', '1430295066', '1430191392', '1427342479', '2015-05-04', '2015-05-04', '300', '', '0000-00-00', '');
...
-- ----------------------------
-- Procedure structure for `sp_Customer_Rent_Payment_Detail`
-- ----------------------------
DROP PROCEDURE IF EXISTS `sp_Customer_Rent_Payment_Detail`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Customer_Rent_Payment_Detail`(IN  _Search NVARCHAR(500), _PayDateFrom Datetime, _PayDateTo Datetime)
BEGIN
IF (_Search="") THEN
	SELECT 
	CP.Customer_RentID AS Customer_RentID,
	CP.UserID AS UserID,
	CP.RentItemID AS RentItemID,
	R.ItemName AS ItemName,
	CS.CustomerID AS CustomerID,
	CS.fullName AS fullName,
	CP.PayDate AS PayDate,
	CP.RealPayDate AS RealPayDate,
	CP.Price AS Price,
	CP.Electric AS Electric,
	CP.Water AS Water,
	CP.garbage AS garbage,
	CP.Other AS Other ,
	CP.TotalPay AS TotalPay
FROM customer_rent_pay CP
INNER JOIN tblrentitem R ON CP.RentItemID=R.RentItemID
INNER JOIN tblcustomer_rent CR ON CP.Customer_RentID=CR.Customer_RentID
INNER JOIN tbcustomer CS ON CS.CustomerID= CR.CustomerID
WHERE Month(CP.PayDate) BETWEEN Month(_PayDateFrom) AND Month(_PayDateTo) 
AND Year(CP.PayDate) BETWEEN Year(_PayDateFrom) AND Year(_PayDateTo);
ELSE
	SELECT 
	CP.Customer_RentID AS Customer_RentID,
	CP.UserID AS UserID,
...
WHERE Month(CP.PayDate) BETWEEN Month(_PayDateFrom) AND Month(_PayDateTo) 
AND Year(CP.PayDate) BETWEEN Year(_PayDateFrom) AND Year(_PayDateTo)
AND (CS.fullName Like CONCAT('%' , _Search , '%') OR R.ItemName Like CONCAT('%' , _Search , '%') );
END IF;
END
;;
DELIMITER ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Customer_Update`(IN  _CustomerID NVARCHAR(50),_CompanyID  NVARCHAR(200),_memberTitle NVARCHAR(200),_firstName NVARCHAR(200),_lastName  NVARCHAR(200),_fullName NVARCHAR(200),_nickName  NVARCHAR(200),_idType  NVARCHAR(200),_icpassportNo NVARCHAR(200),_Nationality NVARCHAR(200) ,_Gender NVARCHAR(200),_Birthdate datetime,_MaritalStatus NVARCHAR(200) ,_Address NVARCHAR(200),_ZipCode NVARCHAR(200),_PostalCode NVARCHAR(200),_POBox  NVARCHAR(200),_City NVARCHAR(200),_Country NVARCHAR(200),_Tel1 NVARCHAR(200),_Fax NVARCHAR(200) ,_Mobile NVARCHAR(200),_eMail NVARCHAR(200) ,_autono int)
BEGIN
