...
INSERT INTO `tblcategory` VALUES ('1429746240', '1427339560', 'etrd', '0', '');
...
-- ----------------------------
INSERT INTO `tblcustomer_rent` VALUES ('1429631215', '1428131505', '1428029924', '1427339560', '0000-00-00', '0000-00-00', '200', '', '0000-00-00', 'asdfasdfasdfsd');
INSERT INTO `tblcustomer_rent` VALUES ('1429632130', '1428133218', '1428029924', '1427342479', '2015-04-10', '2015-04-01', '140', '', '2017-04-10', 'sdfsdfsdfsd');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_Customer_Rent_Select_Company`(IN  _Search NVARCHAR(500))
BEGIN
IF (_Search="") THEN
	SELECT 	
...
ELSE 
  ...
  CR.isLeave AS isLeave,
	...
	INNER JOIN tblcompany CO ON CR.CompanyID=CO.CompanyID
	INNER JOIN tbcustomer C ON CR.CustomerID=C.CustomerID
WHERE (C.fullName Like CONCAT('%' , _Search , '%') OR I.ItemName Like CONCAT('%' , _Search , '%') OR CO.CompanyName Like CONCAT('%' , _Search , '%') OR CR.Description Like CONCAT('%' , _Search , '%')  );
END IF;
END
;;
DELIMITER ;
